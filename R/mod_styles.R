#' UI Styles Module
#'
#' @description CSS styles and JavaScript copied exactly from original perturbplan app
#' but with updated section IDs for the new constraint-driven sidebar
#'
...
create_styles <- function() {
  list(
    ...
    # Add custom CSS to match original perturbplan app exactly
    tags$style(HTML("
    ...
    # Add custom JavaScript for collapsible sections - Updated for new section IDs
    tags$script(HTML("
      ...
      $(document).ready(function() {
        console.log('JavaScript loaded for PerturbPlan v2');
